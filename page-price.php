            ...
            <section class="price">
                ...
                <div class="fees">
                    <div class="fee">
                        ...
                        <div class="fee-price"><p class="price-inner">3000円</p></div>
                    </div>
                    <div class="fee">
        ...
        <article class="personal" id="personal">
            ...
            <div class="personal-price">
                ...
                <div class="once">
                    ...
                    <div class="once-desc">
                        <p class="left">営業時間外や定休日に完全マンツーマンでご指導いたします。</p>
        ...
        <article id="health-class">
            ...
            <article class="visiting-lecture">
                ...
                <div class="lecture-details">
                    ...
                    <div class="lecture-detail">
                        <p class="lecture-y">交通費</p>
                        <p class="lecture-inside">日南市内・・・無料</p>
                        <p class="lecture-inside">日南市外・・・有料（距離に応じて）</p>
                    </div>
                    <div class="healthclass-detail">
                        <p class="lecture-y">出張範囲</p>
                        <p class="lecture-inside">全国どこでも可</p>
                    </div>
                    <div class="healthclass-detail">
                        <p class="lecture-y">お申し込み方法</p>
