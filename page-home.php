...
<div class="top-img">
        <img src="<?php echo get_template_directory_uri(); ?>/images/keiko2.jpg" alt="本気で結果を出したいなら、エクセル">
        <h1>本気で結果を出したいなら、エクセル</h1>
        <h2>GET STRONGER, <span class="green">GO EXCEL</span></h2>
    </div>
    <div class="top-img-s">
        <img src="<?php echo get_template_directory_uri(); ?>/images/keiko3.jpg" alt="本気で結果を出したいなら、エクセル">
        <h1>本気で結果を出したいなら、エクセル</h1>
        <h2>GET STRONGER, <span class="green">GO EXCEL</span></h2>
    </div>
    <div class="wrap">
